...
export default function QuizzitchAbout() {
  return (
    // Increased mobile vertical padding (py-6 sm:py-4)
    <div className="relative z-10 w-full py-6 sm:py-4">
      {/* Increased mobile padding (px-6 py-6 sm:px-8 sm:py-4) */}
      <div className="relative w-full overflow-hidden px-6 py-6 sm:px-8 sm:py-4">
        
        {/* Increased mobile grid gap (gap-12 lg:gap-16) */}
        <div className="relative z-10 grid grid-cols-1 items-center gap-12 lg:grid-cols-12 lg:gap-16">
          ...
          >
            <div>
              {/* Increased bottom margin for mobile heading (mb-10 sm:mb-8) */}
              <h3 className="mb-10 font-baloo text-3xl font-[800] leading-[1.1] tracking-tight text-white sm:mb-8 sm:text-5xl md:text-6xl">
                Ab
              ...
              {/* Increased paragraph gap on mobile (gap-8 sm:gap-6) */}
              <div className="flex flex-col gap-8 font-sans text-base font-normal leading-[1.75] tracking-tight text-white/90 sm:gap-6 sm:leading-[1.65] sm:text-lg lg:text-xl">
                <p>
          ...
          <motion.div
            ...
            className="relative mx-auto flex aspect-square w-full max-w-[580px] items-center justify-center scale-100 p-6 sm:scale-110 sm:p-0 lg:col-span-5 lg:h-[620px] lg:scale-125"
          >
            <Image
              src={image}
