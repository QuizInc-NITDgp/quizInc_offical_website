              ...
              >
                ...
                <div className="relative w-fit">
                  <motion.h2
                    ...
                    className="mt-2 sm:mt-3 text-3xl sm:text-4xl md:text-5xl font-[800] tracking-tight bg-gradient-to-r from-white via-red-100 to-red-500 bg-clip-text text-transparent drop-shadow-[0_0_25px_rgba(255,30,67,0.35)] font-baloo pb-2"
                  >
                    {event.name}
                  </motion.h2>

                  {/* Moving Animated Red-White Gradient Line */}
                  <motion.div
                    variants={{
                ...
                <motion.p
                  ...
                  className="mt-4 sm:mt-6 text-base sm:text-lg md:text-xl text-gray-200/95 leading-relaxed font-medium tracking-wide whitespace-pre-line font-sans"
                >
                  {event.description}
                </motion.p>
